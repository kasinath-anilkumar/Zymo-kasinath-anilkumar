    ...
    <>
      <div className="mb-12 p-12 text-white bg-gradient-to-r from-[#5542b1e5] to-[#a738d3] py-16 font-poppins mx-4 rounded-2xl ">
        ...
        <p class="mb-6">
          ...
          traffic, having the freedom to rent a car on your terms makes life
          much easier. Zymo allows you to choose from a variety of cars, from
        ...
        <ul class="list-disc list-inside space-y-2 mb-6 ml-8">
          ...
          <li>
            <strong>Flexible Rental Periods:</strong> Need a car for a few hours
            or a whole week? Zymo offers flexible rental options to fit your
            schedule.
          </li>
          <li>
            <strong>Wide Range of Cars:</strong> From economy hatchbacks to
            luxury sedans and SUVs, pick a car that suits your style and needs.
          </li>
          <li>
            <strong>Hassle-Free Booking:</strong> Book online or through our
            app, choose your preferred car and location, and hit the road! It’s
            that simple.
          </li>
        </ul>
        ...
        <p class="mb-6">
          ...
          scenic spots, or just need a ride for errands, Zymo’s self-drive car
