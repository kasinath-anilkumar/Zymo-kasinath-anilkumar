...
function About() {
  return (
    <div className={classes.aboutContainer}>
      ...
      <br></br>
      <p>
        At Zymo, we are more than just a rental platform. We are your partner in
        adventure, here to help you explore the beauty of India on your own
        terms. With our vast collection of cars, transparent pricing, and
        exceptional customer service, you can trust us to deliver a self-drive
